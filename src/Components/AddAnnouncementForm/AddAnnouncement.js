        ...
        <div className="add">
            <div className="wrapper">
                <form  className="add__form" onSubmit={()=>addAnnouncementH(valueTitleH,valueDescriptionH,announcementsH)}>
                    ...
                    <textarea  className={descriptionErrorH === true ? "error" : null} value={valueDescriptionH}  onChange={changeDescriptionH} onInput={removeDescriptionErrorBorderH} rows="30" placeholder="Announcement"/>
